...
{/*defining paths */}
        <div className="container">
          <Switch>
            ...
            <Route path="/users">
              <Listusers newlist={newlist} setnewlist={setnewlist} />
            </Route>

            <Route path="/create-user">
              <Createuser newlist={newlist} setnewlist={setnewlist} />
            </Route>
            {/* "/:id" is dynamic, which is formed when the corresponding button is clicked */}
            <Route path="/edit-user/:id">
              <Edituser newlist={newlist} />
            </Route>
            <Route path="/profile/:id">
              <Profile newlist={newlist} />
            </Route>
...
//creates new user
function Createuser({ newlist, setnewlist }) {
  {/*details of new user */}
...
function Listusers({ newlist, setnewlist }) {
